...
delta_t2= nu * hx /c
ht=  0.00002 #min(np.abs(delta_t1),np.abs(delta_t2))
print(ht)
#print(delta_t1)
#print(delta_t2)
...
Nt = 4# Durée de l'intervalle temporel
...
for n in range(nbrt):
    erreur_n = np.linalg.norm(solutionsApprochées[:,n]-solutionExacte[:,n])
    erreurs2.append(erreur_n)
 

erreur3 = max(erreurs2)   
print(erreur3) 
